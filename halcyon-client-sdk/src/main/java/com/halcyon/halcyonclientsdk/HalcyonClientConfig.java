package com.halcyon.halcyonclientsdk;
...
// 这里给所有的配置加上前缀为"halcyon-api.client"
@ConfigurationProperties("halcyon-api.client")
// @Data 注解是一个 Lombok 注解,自动生成了类的getter、setter方法
@Data
// @ComponentScan 注解用于自动扫描组件，使得 Spring 能够自动注册相应的 Bean
@ComponentScan
public class HalcyonClientConfig {
    private String accessKey;
    private String secretKey;

    @Bean
    public OpenApiClient openApiClient(){
        //使用aK 和 sK 创建一个 OpenApiClient 对象
